...
//var player;		//this file only called depend on usage, use window.player instead
...
function onPlayerReady(event) {
	//$(function(){load('tests/'+cid+'.xml');});	//loaded after canvas setup
	load('tests/'+cid+'.xml');		//without check since yt api load slower than local
